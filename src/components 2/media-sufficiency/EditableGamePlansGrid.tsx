...
interface EditableGamePlansGridProps {
  data: any[];
  onDataChange?: (updatedData: any[]) => void;
}

const EditableGamePlansGrid: React.FC<EditableGamePlansGridProps> = ({ data, onDataChange }) => {
  ...
  const columns = [
    ...
    { key: 'campaign.name', label: 'Campaign', editable: false },
    { key: 'mediaSubType.mediaType.name', label: 'Media Type', editable: false },
    { key: 'mediaSubType.name', label: 'Media Sub Type', editable: false },
    { key: 'country.name', label: 'Country', editable: false },
    { key: 'category.name', label: 'Category', editable: false },
    { key: 'pmType.name', label: 'PM Type', editable: false },
    { key: 'startDate', label: 'Start Date', editable: true, type: 'date' },
    { key: 'endDate', label: 'End Date', editable: true, type: 'date' },
    { key: 'totalBudget', label: 'Total Budget', editable: true, type: 'currency' },
    { key: 'q1Budget', label: 'Q1 Budget', editable: true, type: 'currency' },
    { key: 'q2Budget', label: 'Q2 Budget', editable: true, type: 'currency' },
    { key: 'q3Budget', label: 'Q3 Budget', editable: true, type: 'currency' },
    { key: 'q4Budget', label: 'Q4 Budget', editable: true, type: 'currency' },
  ];
...
export default EditableGamePlansGrid;
