...
import { TvDiminishingReturnsValidator } from '@/lib/validation/tvDiminishingReturnsValidator';
...
export async function POST(request: NextRequest) {
  try {
    ...
    const validator = new TvDiminishingReturnsValidator(masterData, businessUnitName, countryName);
    ...
    console.error('TV Diminishing Returns validation error:', error);
    return NextResponse.json({
