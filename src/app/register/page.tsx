          ...
          <div className="bg-white p-4 sm:p-6 rounded-lg shadow-md">
            <div className="text-center">
              ...
              <p className="text-sm text-gray-600 mb-4">
                You can now directly login with your credentials.
              </p>
              <Link
                href="/login"
          ...
          <div className="space-y-4">
            ...
            <div>
              ...
              <select
                ...
                name="countryId"
                required
                className={`appearance-none relative block w-full px-4 py-3 border text-gray-900 rounded-lg focus:outline-none focus:ring-2 focus:ring-indigo-500 focus:border-indigo-500 focus:z-10 sm:text-sm ${
                  loadingCountries 
              ...
              {!loadingCountries && countries.length === 0 && (
                <p className="text-xs text-red-500 mt-1">Failed to load countries. Please refresh the page.</p>
              )}
            </div>
          </div>
