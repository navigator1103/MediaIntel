    ...
    try {
      ...
      try {
        ...
        if (data.user) {
          ...
          console.log('Stored user data:', JSON.stringify(data.user));
          console.log('Verification - user from localStorage:', localStorage.getItem('user'));
          console.log('Token cookie set:', document.cookie);
          
          // Use longer timeout to ensure localStorage is saved before redirect
          setTimeout(() => {
