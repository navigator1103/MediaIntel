...
interface MultimediaTargetAudienceFormProps {
  countryId: number;
...
export default function MultimediaTargetAudienceForm({
  countryId,
  businessUnitId,
  audiences,
  onAudiencesChange,
  onGenerateTable,
  onLoadExisting
}: MultimediaTargetAudienceFormProps) {
  ...
  React.useEffect(() => {
    const checkExistingData = async () => {
      ...
      try {
        const response = await fetch(`/api/admin/multimedia-diminishing-returns/audiences?countryId=${countryId}&businessUnitId=${businessUnitId}`);
        if (response.ok) {
    ...
    <div className="space-y-6">
      ...
      <div className="bg-white rounded-lg border border-gray-200">
        <div className="px-6 py-4 border-b border-gray-200">
          <div>
            <h3 className="text-lg font-medium text-gray-900">Multimedia Target Audiences</h3>
            <p className="text-sm text-gray-500 mt-1">
              Define the target audiences for your multimedia diminishing returns curves.
            </p>
          </div>
        </div>
        ...
        <div className="p-6">
                  ...
                  <tr key={audience.id}>
                    ...
                    <td className="px-4 py-3 whitespace-nowrap">
                      <input
                        ...
                        className="block w-32 text-sm border-gray-300 rounded-md focus:ring-purple-500 focus:border-purple-500 bg-gray-50"
          ...
          <div className="mt-4 flex justify-between items-center">
            ...
            <button
              ...
              className="inline-flex items-center px-4 py-2 text-sm font-medium rounded-md bg-purple-600 text-white hover:bg-purple-700 disabled:opacity-50 disabled:cursor-not-allowed"
            >
